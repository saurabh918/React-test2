...
const Search = () => {
  ...
  return (
    <StyledSearch>
    <input type="text" value={searchQuery} onChange={handleInputChange} placeholder='search more recipes' />
    <StyledRecipeContainer>
      <StyledRecipeList className="recipe-list">
        {searchQuery && searchResults &&
          searchResults.map((recipe) => (
            <RecipeCard key={recipe.idMeal} recipe={recipe} api="apiData" saveButton={true} />
          ))}
      </StyledRecipeList>
    </StyledRecipeContainer>
  </StyledSearch>
